...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        'relative flex w-full cursor-default items-center rounded-8 typography-regular-14 outline-hidden select-none px-8 py-4',
        'data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
        '*:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2',
        'hover:bg-black-4 hover:cursor-pointer',
