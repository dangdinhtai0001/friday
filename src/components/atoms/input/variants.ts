...
export const inputVariants = cva(
  [
    "text-black-100 border-black-10 bg-background-5 rounded-8 border-[0.5px] outline-none",
    "hover:border-black-40",
    "disabled:bg-black-4 disabled:pohinter-events-none disabled:cursor-not-allowed disabled:opacity-50 disabled:text-black-20",
